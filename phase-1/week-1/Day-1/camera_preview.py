...
with dai.Device() as device:
    ...
    streams = []
    #For every camera on this device, build a small pipeline that gets the video and sends it back to my computer.
    for cam in cams:
    ...
    while not device.isClosed():
        ...
        #retrieve and display the processed video frames
